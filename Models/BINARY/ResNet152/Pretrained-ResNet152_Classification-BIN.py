...
def create_model(input_shape, num_classes):
    ...
    # Freezing the weights for the pretrained layers
...
# Build model.
resnet152_model = create_model((128,128,64,3), 2)
...
checkpoint_cb = keras.callbacks.ModelCheckpoint("3D_ALZ_ResNet152_v2.h5", save_best_only = True, verbose = 1)
...
csv_log = keras.callbacks.CSVLogger("ResNet152_history_{}_v2".format('classification'), append = True)
