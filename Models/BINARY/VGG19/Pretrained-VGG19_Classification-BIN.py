...
VGG19 , preprocess_input = Classifiers_3D.get('vgg19') # 3D VGG19
...
def create_model(input_shape, num_classes):
    ...
    model = Model(inputs = conv_base.input, outputs = output_layer, name = '3D_VGG19')
    
    return model 

# Build model.
vgg19_model = create_model((128,128,64,3), 2)
vgg19_model.summary()
...
checkpoint_cb = keras.callbacks.ModelCheckpoint("3D_ALZ_VGG19_v3.h5", save_best_only = True, verbose = 1)
...
csv_log = keras.callbacks.CSVLogger("VGG19_history_{}_v3".format('classification'), append = True)
