...
# Build model.
vgg19_model = create_model((128,128,64,3), 3)
vgg19_model.summary()
...
checkpoint_cb = keras.callbacks.ModelCheckpoint("3D_ALZ_VGG19_v2.h5", save_best_only = True, verbose = 1)
...
csv_log = keras.callbacks.CSVLogger("VGG19_history_{}_v2".format('classification'), append = True)
