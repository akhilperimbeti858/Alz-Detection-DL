...
# Build model.
vgg16_model = create_model((128,128,64,3), 3)
vgg16_model.summary()
...
checkpoint_cb = keras.callbacks.ModelCheckpoint("3D_ALZ_VGG16_v2.h5", save_best_only = True, verbose = 1)
...
csv_log = keras.callbacks.CSVLogger("VGG16_history_{}_v2".format('classification'), append = True)
